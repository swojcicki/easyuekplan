...
import pl.krakow.uek.knp.easyuekplan.xml.teacher.Zajecia;
 ...
 */
public class TeacherPlan implements ApolloPlan {

  private PlanZajec planZajec;

  public TeacherPlan(PlanZajec planZajec) {
  ...
  public String getTitle(Object zajecia) {
    Zajecia z = (Zajecia) zajecia;
    return new StringBuilder().append("[").append(z.getTyp()).append("] ").append(z.getPrzedmiot()).toString();
  }

 ...
 * generated in the pl.krakow.uek.knp.easyuekplan.xml.teacher package.
...
public class ObjectFactory {
  ...
  private final static QName _Grupa_QNAME = new QName("", "grupa");
  ...
  private final static QName _Uwagi_QNAME = new QName("", "uwagi");
  ...
  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pl.krakow.uek.knp.easyuekplan.xml.teacher
   */
   ...
   */
  @XmlElementDecl(namespace = "", name = "grupa")
  public JAXBElement<String> createGrupa(String value) {
    return new JAXBElement<String>(_Grupa_QNAME, String.class, null, value);
  }
